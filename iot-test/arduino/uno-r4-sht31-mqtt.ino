...
const int MQTT_PORT = 1883;                    // 1883 = non-TLS
...
#define SHT31_ADDR 0x44 // ใช้ 0x45 ถ้า ADR ต่อ VCC
// ==========================
...
void connectMQTT()
{
    ...
    // แจ้งสถานะ online (แก้ JSON ที่เคยพิมพ์เพี้ยน)
...
void setup()
{
    ...
    Serial.println("UNO R4 WiFi + SHT31 → MQTT (plain text payload)");
